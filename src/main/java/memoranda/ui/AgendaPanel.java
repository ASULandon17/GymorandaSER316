				...
				if (e.getEventType() == HyperlinkEvent.EventType.ACTIVATED) {
					...
					if (d.equalsIgnoreCase("memoranda:events"))
						...
						if (!dlg.CANCELLED) {
						 ...
						 String name = JOptionPane.showInputDialog(parent,Local.getString("Enter the name of the file to export as .txt"),null);
						 new ExportSticker(name).export("txt");
						 //JOptionPane.showMessageDialog(null,name);
					}else if (d.startsWith("memoranda:exportstickersh")) {
						 /*  Falta agregar el exportar sticker mientras tanto..*/
						 final JFrame parent = new JFrame();
						 String name = JOptionPane.showInputDialog(parent,Local.getString("Enter the name of the file to export as .html"),null);
