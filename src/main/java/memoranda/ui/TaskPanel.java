    ...
    void jbInit() throws Exception {
        ...
        newTaskB.setIcon(
                new ImageIcon(Objects.requireNonNull(AppFrame.class
                        .getResource("/ui/icons/todo_new.png"))));
        ...
        subTaskB.setIcon(
                new ImageIcon(Objects.requireNonNull(AppFrame.class
                        .getResource("/ui/icons/todo_new_sub.png"))));
...
//        editTaskB.setEnabled(true);
        editTaskB.setIcon(
                new ImageIcon(Objects.requireNonNull(AppFrame.class
                        .getResource("/ui/icons/todo_edit.png"))));
        ...
        removeTaskB.setIcon(
                new ImageIcon(Objects.requireNonNull(AppFrame.class
                        .getResource("/ui/icons/todo_remove.png"))));
        ...
        completeTaskB.setIcon(
                new ImageIcon(Objects.requireNonNull(AppFrame.class
                        .getResource("/ui/icons/todo_complete.png"))));
        ...
        ppEditTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class
                .getResource("/ui/icons/todo_edit.png"))));
        ...
        ppRemoveTask.addActionListener(this::ppRemoveTask_actionPerformed);
        ppRemoveTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class
                .getResource("/ui/icons/todo_remove.png"))));
        ppRemoveTask.setEnabled(false);
        ppNewTask.setFont(new java.awt.Font("Dialog", 1, 11));
        ppNewTask.setText(Local.getString("New task") + "...");
        ppNewTask.addActionListener(this::ppNewTask_actionPerformed);
        ppNewTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class
                .getResource("/ui/icons/todo_new.png"))));

        ppAddSubTask.setFont(new java.awt.Font("Dialog", 1, 11));
        ppAddSubTask.setText(Local.getString("Add subtask"));
        ppAddSubTask.addActionListener(this::ppAddSubTask_actionPerformed);
        ppAddSubTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class
                .getResource("/ui/icons/todo_new_sub.png"))));
        ...
        ppCompleteTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class
                .getResource("/ui/icons/todo_complete.png"))));
        ppCompleteTask.setEnabled(false);

        ppCalcTask.setFont(new java.awt.Font("Dialog", Font.BOLD, 11));
        ppCalcTask.setText(Local.getString("Calculate task data"));
        ppCalcTask.addActionListener(this::ppCalcTask_actionPerformed);
        ppCalcTask.setIcon(new ImageIcon(Objects.requireNonNull(AppFrame.class
                .getResource("/ui/icons/todo_complete.png"))));
        ...
        CurrentDate.addDateListener(d -> newTaskB
                .setEnabled(d.inPeriod(CurrentProject.get().getStartDate(),
        ...
        taskTable.getSelectionModel().addListSelectionListener(e -> {
            ...
            if (enbl) {
                String thisTaskId = taskTable.getModel().getValueAt(taskTable.getSelectedRow(),
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
    ...
    void addSubTask_actionPerformed(ActionEvent e) {
        TaskDialog dlg = new TaskDialog(App.getFrame(), Local.getString("New Task"));
        String parentTaskId = taskTable.getModel().getValueAt(taskTable.getSelectedRow(),
                TaskTable.TASK_ID).toString();
...
//        CalendarDate ed = new CalendarDate((Date) dlg.endDate.getModel().getValue());
        ...
        long effort = Util.getMillisFromHours(dlg.effortField.getText());
        Task newTask = CurrentProject.getTaskList().createTask(sd, ed, dlg.todoField.getText(),
                dlg.priorityCB.getSelectedIndex(), effort, dlg.descriptionField.getText(),
                parentTaskId);
        newTask.setProgress(((Integer) dlg.progress.getValue()).intValue());
//		CurrentProject.getTaskList().adjustParentTasks(newTask);
    ...
    void calcTask_actionPerformed(ActionEvent e) {
        ...
        dlg.pack();
        Task t = CurrentProject.getTaskList().getTask(taskTable.getModel().getValueAt(taskTable.
                getSelectedRow(), TaskTable.TASK_ID).toString());
...
//		
    ...
    void removeTaskB_actionPerformed(ActionEvent e) {
        ...
        if (taskTable.getSelectedRows().length > 1)
            msg = Local.getString("Remove") + " " + taskTable.getSelectedRows().length + " "
        ...
        for (int i = 0; i < taskTable.getSelectedRows().length; i++) {
            Task t =
                    CurrentProject.getTaskList().getTask(
                            taskTable.getModel().getValueAt(taskTable.getSelectedRows()[i],
                                    TaskTable.TASK_ID).toString());
            if (t != null)
                toremove.add(t);
        }
